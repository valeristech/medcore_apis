...
export const pacienteRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.get(
    "/pacientes/:id/alergias/:alergiaId",
    {
      ...obtenerAlergiaSchema,
      preHandler: [requireAuth, pLeer],
    },
  ...
  /** GET /pacientes/:id/seguros/:seguroId — Obtener seguro por ID */
  app.get(
    "/pacientes/:id/seguros/:seguroId",
    {
      ...obtenerSeguroSchema,
      preHandler: [requireAuth, pLeer],
    },
    pacienteController.getSeguro,
  );
